...
Updated by Lakshita Vijay:
- ResNetBranchEarly: replaced spatial concatenation with clinical-guided attention
- TriSeriesModel: updated feature_dim, removed freeze/unfreeze, keep ResNet frozen
"""
import torch
